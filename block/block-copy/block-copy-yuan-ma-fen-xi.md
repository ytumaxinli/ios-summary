...
> }
>
> //内部调用block源码_Block_object_assign方法拷贝结构体成员a
...
> }
>
> //block结构体。新增成员__Block_byref_a_0 *a指针
...
>   (a.__forwarding->a) = 2;
>   ((void (*)(__block_impl *))((__block_impl *)blockDataBlock)->FuncPtr)((__block_impl *)blockDataBlock);
>   NSLog((NSString *)&__NSConstantStringImpl__var_folders_s9_886c185n58l8zmt9rwkglcsc0000gn_T_BlockStructureViewController_553b77_mi_19, (a.__forwarding->a));
> }
> ```

block源码分析

> 1.调用void \*\_Block\_copy\(constvoid \*arg\)方法将栈结构体拷贝到堆上
>
> 2.调用desc的copy方法
>
> 3.调用\_Block\_object\_assign，flags=8/\*BLOCK\_FIELD\_IS\_BYREF\*/
>
> ```
> void _Block_object_assign(void *destArg, const void *object, const int flags) {
>     
...
> ```
>
> 4.调用\_Block\_byref\_copy，arg为栈block
>
> ```
